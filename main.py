...
class MainApp :
    ...
    def _title_frame_element_builder(self, title_frame):
        # Title
        title_label = tk.Label(title_frame, text="Video Game Database Application", font=("Helvetica", 16, "bold"))
        title_label.pack(pady=20)
        # Description
        description_label = tk.Label(title_frame, text="This application allows users to insert, update, and delete information about video games.", font=("Helvetica", 12))
    ...
    def setup_main_screen(self):
        ...
        fetch_function_parent_frame.configure(height=100)
        ...
        insert_function_parent_frame.configure()
        ...
        delete_function_parent_frame.configure()
        ...
        # Frame 5 : Admin functions
        admin_function_parent_frame = tk.Frame(initial_frame)
